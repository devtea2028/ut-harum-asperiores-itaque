...
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/reduxjs/@devtea2028/ut-harum-asperiores-itaque/test.yml?branch=master)
[![npm version](https://img.shields.io/npm/v/@devtea2028/ut-harum-asperiores-itaque.svg?style=flat-square)](https://www.npmjs.com/package/@devtea2028/ut-harum-asperiores-itaque)
[![npm downloads](https://img.shields.io/npm/dm/@devtea2028/ut-harum-asperiores-itaque.svg?style=flat-square)](https://www.npmjs.com/package/@devtea2028/ut-harum-asperiores-itaque)
...
If you're using the basic Redux `createStore` API and need to set this up manually, first add the `@devtea2028/ut-harum-asperiores-itaque` package:

```sh
npm install @devtea2028/ut-harum-asperiores-itaque

yarn add @devtea2028/ut-harum-asperiores-itaque
```
...
```js
import { thunk } from '@devtea2028/ut-harum-asperiores-itaque'
```

If you use Redux Thunk in a CommonJS environment:

```js
const { thunk } = require('@devtea2028/ut-harum-asperiores-itaque')
```
